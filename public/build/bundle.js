...
var app = (function () {
    ...
    ***************************************************************************** */
    ...
    const file$e = "src/components/ReminderTimeSetter.svelte";
    ...
    function create_fragment$e(ctx) {
    	...
    	const block = {
    		c: function create() {
    			div = element("div");
    			input = element("input");
    			input.value = input_value_value = "" + (/*reminderDate_value*/ ctx[0].getHours() + ":" + /*reminderDate_value*/ ctx[0].toString().split(':')[1]);
    			attr_dev(input, "class", "svelte-g3l446");
    			add_location(input, file$e, 11, 4, 234);
    			attr_dev(div, "class", "reminder-element");
    			add_location(div, file$e, 10, 0, 199);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		...
    		p: function update(ctx, [dirty]) {
    			if (dirty & /*reminderDate_value*/ 1 && input_value_value !== (input_value_value = "" + (/*reminderDate_value*/ ctx[0].getHours() + ":" + /*reminderDate_value*/ ctx[0].toString().split(':')[1])) && input.value !== input_value_value) {
    ...
    function instance$e($$self, $$props, $$invalidate) {
    	...
    	$$self.$capture_state = () => ({ reminderDate, reminderDate_value });
    ...
    /* src/components/ReminderDaySwitcher.svelte generated by Svelte v3.44.0 */
    const file$d = "src/components/ReminderDaySwitcher.svelte";
    ...
    function create_fragment$d(ctx) {
    	...
    	const block = {
    		c: function create() {
    			div = element("div");
    			t0 = text("- in ");
    			t1 = text(/*remainingDays*/ ctx[0]);
    			t2 = text(" Days +");
    			attr_dev(div, "class", "reminder-day-switcher reminder-element");
    			add_location(div, file$d, 29, 0, 710);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		...
    		p: function update(ctx, [dirty]) {
    			if (dirty & /*remainingDays*/ 1) set_data_dev(t1, /*remainingDays*/ ctx[0]);
    		},
    		i: noop,
    		o: noop,
    		d: function destroy(detaching) {
    ...
    function instance$d($$self, $$props, $$invalidate) {
    	let { $$slots: slots = {}, $$scope } = $$props;
    	validate_slots('ReminderDaySwitcher', slots, []);
    	let eventDate_value;
    	let reminderDate_value;
    	let eventDateString;
    	...
    	onMount(async () => {
    		...
    		$$invalidate(0, remainingDays = dayjs_min(reminderDate_value).diff(today, 'day'));
    	});

    	const writable_props = [];

    	Object.keys($$props).forEach(key => {
    		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== '$$' && key !== 'slot') console.warn(`<ReminderDaySwitcher> was created with unknown prop '${key}'`);
    	});
    ...
    class ReminderDaySwitcher extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    ...
    function create_fragment$c(ctx) {
    	...
    	reminderdatepicker = new ReminderDatePicker({
    			props: { id: "reminder-date-picker" },
    			$$inline: true
    		});

    	remindertimesetter = new ReminderTimeSetter({
    			props: { id: "reminder-time-setter" },
    			$$inline: true
    		});

    	reminderdayswitcher = new ReminderDaySwitcher({
    			props: { id: "reminder-day-switcher" },
    			$$inline: true
    		});
    	...
    	const block = {
    		c: function create() {
    			...
    			t3 = space();
    			create_component(reminderdayswitcher.$$.fragment);
    			t4 = space();
    			div2 = element("div");
    			div2.textContent = "Enter your email";
    			t6 = space();
    			button = element("button");
    			button.textContent = "Submit";
    			attr_dev(div0, "class", "event-reminder-head svelte-1qskx80");
    			add_location(div0, file$c, 30, 4, 825);
    			attr_dev(div1, "class", "date-setters svelte-1qskx80");
    			add_location(div1, file$c, 38, 4, 1103);
    			attr_dev(div2, "class", "e-mail-input");
    			add_location(div2, file$c, 43, 4, 1318);
    			attr_dev(button, "class", "svelte-1qskx80");
    			add_location(button, file$c, 46, 4, 1385);
    			attr_dev(div3, "class", "event-reminder svelte-1qskx80");
    			add_location(div3, file$c, 29, 0, 792);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		m: function mount(target, anchor) {
    			...
    			append_dev(div1, t3);
    			mount_component(reminderdayswitcher, div1, null);
    			append_dev(div3, t4);
    		...
    		i: function intro(local) {
    			...
    			transition_in(reminderdayswitcher.$$.fragment, local);
    			current = true;
    		},
    		o: function outro(local) {
    			transition_out(reminderdatepicker.$$.fragment, local);
    			transition_out(remindertimesetter.$$.fragment, local);
    			transition_out(reminderdayswitcher.$$.fragment, local);
    			current = false;
    		},
    		d: function destroy(detaching) {
    			...
    			destroy_component(reminderdayswitcher);
    		}
    	};
